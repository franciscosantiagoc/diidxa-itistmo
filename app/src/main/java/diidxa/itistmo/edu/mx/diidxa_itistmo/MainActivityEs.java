    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if(getArguments().getInt(ARG_SECTION_NUMBER)==1) {
                rootView = inflater.inflate(R.layout.fragment_dic_es, container, false);
            /*View rootView = inflater.inflate(R.layout.fragment_main_activity_es, container, false);
            TextView textView = (TextView) rootView.findViewById(R.id.section_label);
            textView.setText(getString(R.string.section_format, getArguments().getInt(ARG_SECTION_NUMBER)));*/
            }else{
                rootView = inflater.inflate(R.layout.fragment_bus_es, container, false);
            }
            return rootView;
        }
    }
